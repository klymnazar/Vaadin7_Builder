...
//		System.out.println(sql);
	...
	public List<Flat> getSoldedFlatsFromDB() throws SQLException {
		...
		String sql = "SELECT * FROM flatTable WHERE flatSet = 'Solded'";
...
//		System.out.println(sql);
	...
	public Flat getFlatByFlatId(int flatId) throws SQLException {
