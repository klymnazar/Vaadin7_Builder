...
public class Flat {
	...
	private int spendTableSum;
	private String spendTableCurrency;
	private String spendTableCategory;
	private String spendTableValue;
	...
	public int getSpendTableSum() {
		return spendTableSum;
	}
	public void setSpendTableSum(int spendTableSum) {
		this.spendTableSum = spendTableSum;
	}
	public String getSpendTableCurrency() {
		return spendTableCurrency;
	}
	public void setSpendTableCurrency(String spendTableCurrency) {
		this.spendTableCurrency = spendTableCurrency;
	}
	public String getSpendTableCategory() {
		return spendTableCategory;
	}
	public void setSpendTableCategory(String spendTableCategory) {
		this.spendTableCategory = spendTableCategory;
	}
	public String getSpendTableValue() {
		return spendTableValue;
	}
	public void setSpendTableValue(String spendTableValue) {
		this.spendTableValue = spendTableValue;
	}
